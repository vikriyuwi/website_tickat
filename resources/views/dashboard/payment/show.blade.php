...
<li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{ url('/dashboard/payment') }}">Payment</a></li>
                    ...
                    <div class="card-header p-3">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-end">
                                <a href="{{ url('/dashboard/payment/'.$payments->PaymentId.'/edit') }}">
