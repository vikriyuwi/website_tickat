            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-md-6">
                                <h6>Ticket Readem Data - PENDING</h6>
                            </div>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-md-6">
                                <h6>Ticket Readem Data - READY TO USE</h6>
                            </div>
                            <div class="col-md-6 text-end">
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-md-6">
                                <h6>Ticket Readem Data - EXPIRED</h6>
                            </div>
                            <div class="col-md-6 text-end">
